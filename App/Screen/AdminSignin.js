...
import { View, Image, FlatList,ToastAndroid, Text, StyleSheet, TouchableOpacity, ActivityIndicator, StatusBar, ScrollView, } from 'react-native';
import {
    responsiveHeight,
    responsiveWidth,
    responsiveFontSize
    ...
    return(
        <View style={{backgroundColor:'#fff',flex:1}}>
            ...
            <View style={{width:responsiveWidth(80),alignSelf:'center'}}>
             <Text style={{fontSize:FontSizes.heading,fontWeight:'bold',color:Colors.green,alignSelf:'center'}}>Sign in to your account</Text>
             <TextInput
                style={{margin:10}}
            ...
            />
            <Text></Text>
            <Button mode='contained' onPress={()=>AdminSign()}  style={{borderRadius:10,backgroundColor:Colors.green,width:'90%',alignSelf:'center'}}><Text style={{fontSize:FontSizes.buttonText}} >Sign in</Text></Button>
